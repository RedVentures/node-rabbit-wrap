...
Exchange.prototype.send = function (key, msg, options, cb) {
    ...
    if (contentType) {
        //if there's a content type, copy it to the headeres
        options.headers = options.headers || {};
        options.headers.properties = options.headers.properties || {}

        options.headers.properties.content_type = contentType;
    }
