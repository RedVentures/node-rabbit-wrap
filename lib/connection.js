...
Connection.prototype.connect = function (cb) {
	...
	this.after('connection', 'ready', cb);
...
Connection.prototype.error = function (cb) {
	this.after('connection', 'ready', function () {
		this.amqp.once('error', cb);
	}, this, true);
...
Connection.prototype.exchange = function (name, options, cb) {
	...
	return new Exchange(this, name, options, cb);
};
...
Connection.prototype.queue = function (name, options, cb) {
	return new Queue(this, name, options, cb);
};
